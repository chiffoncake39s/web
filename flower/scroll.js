...
//サイトのタイトル,ギャラリーのタイトル,インフォメーションのタイトルのスクロール
show_robot.observe(document.querySelector("#text0"));
show_robot.observe(document.querySelector(".text1"));
show_robot.observe(document.querySelector("#text2"));